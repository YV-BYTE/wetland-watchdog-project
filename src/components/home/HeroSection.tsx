        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-wetland-light-green p-2 rounded-lg shadow-lg transform rotate-3 relative z-10">
              <img
                src="https://images.unsplash.com/photo-1500829243541-74b677fecc30?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80"
            ...
            <div className="absolute -bottom-6 -right-6 bg-wetland-water-blue p-2 rounded-lg shadow-lg transform -rotate-6 w-48 h-48 md:w-64 md:h-64">
              <img
                src="https://images.unsplash.com/photo-1618777316328-04ef8274b651?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                alt="Wetland birds"
            ...
            <div className="absolute -top-6 -left-6 bg-accent p-2 rounded-lg shadow-lg transform rotate-6 w-36 h-36 md:w-48 md:h-48">
              <img
                src="https://images.unsplash.com/photo-1437622368342-7a3d73a34c8f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                alt="Wetland plants"
                className="rounded-md object-cover w-full h-full"
              />
            </div>
